...
const FraudSimulatorNew = () => {
  ...
  const tx = {
    ...
    hi: {
      ...
      awarenessBasic: "आजकल बैंकिंग आपके फोन पर UPI (GPay, PhonePe) और नेटबैंकिंग के जरिए होती है। वे जीवन को आसान बनाते हैं, लेकिन ठग भी चोरी करने के लिए तकनीक का उपयोग करते हैं।",
      awarenessRule1: "नियम 1: कॉलर आईडी पर भरोसा न करें। ठग बैंक नंबर की नकल करते हैं।",
      awarenessRule2: "नियम 2: कॉल करने वाले के अनुरोध पर रिमोट ऐप (AnyDesk) कभी इंस्टॉल न करें।",
      awarenessRule3: "नियम 3: पैसा 'प्राप्त' करने के लिए कभी भी UPI पिन की आवश्यकता नहीं होती।",
      ...
      introAudio: "डिजिटल धोखाधड़ी जागरूकता में आपका स्वागत है। आजकल बैंकिंग आपके फोन पर UPI के माध्यम से होती है। वे सुरक्षित हैं, लेकिन ठग आपको बरगलाने की कोशिश करते हैं। नियम 1: OTP या UPI PIN कभी साझा न करें। नियम 2: अज्ञात SMS लिंक पर कभी क्लिक न करें। नियम 3: झूठी जल्दबाजी हमेशा एक घोटाला है।",
    ...
    mr: {
      ...
      awarenessBasic: "आधुनिक बँकिंग तुमच्या फोनवर UPI आणि नेटबँकिंग (GPay, PhonePe) वापरून केली जाते. ते जीवन सोपे करतात, परंतु फसवणूक करणारे चोरी करण्यासाठी तंत्रज्ञानाचा वापर करतात.",
      awarenessRule1: "नियम १: कॉलर आयडीवर विश्वास ठेवू नका. ठग बँकेच्या नंबरची हुबेहूब कॉपी करतात.",
      awarenessRule2: "नियम २: कॉलरच्या सांगण्यावरून स्क्रीन शेअरिंग अॅप (AnyDesk) स्थापित करू नका.",
      awarenessRule3: "नियम ३: पैसे 'मिळवण्यासाठी' तुम्हाला कधीही UPI पिन टाकण्याची गरज नसते.",
      ...
      introAudio: "डिजिटल फसवणूक जागरूकता मध्ये आपले स्वागत आहे. अत्याधुनिक बँकिंग तुमच्या फोनवर होते. नियम १: कधीही OTP किंवा UPI पिन देऊ नका. नियम २: मेसेज मधील अनोळखी लिंक उघडू नका. नियम ३: कोणी अति घाई दाखवत असेल तर तो घोटाळा आहे.",
